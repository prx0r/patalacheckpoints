...
WORK_IDENTITY_LADDER = ("UNKNOWN", "DISCOVERED", "CATALOG_MATCHED", "MULTI_SOURCE_MATCHED")
AUTHORSHIP_LADDER = ("UNKNOWN", "SELF_ATTRIBUTED", "CATALOG_SUPPORTED", "MULTI_SOURCE_CONFIRMED")
EDITION_IDENTITY_LADDER = ("UNKNOWN", "DISCOVERED", "CATALOG_MATCHED", "COPY_INSPECTED", "EDITION_VERIFIED")
