...
def build_gold_002() -> dict:
    ...
    nodes = [
        ...
        {"proposition_id": "G2-IMPL",
         ...
         "grounding": {"passage_id": V2L_PASSAGE_ID, "c1_id": V2L_C1_ID,
                       "l200_assertion_id": V2L_L200_ID},
         "boundary": "this is the suppressed premise that makes the reply work — it must be reconstructed",
         "status": "MACHINE_PROPOSED"},
    ...
    inferences = [
        {"inference_id": "G2-INF1",
         ...
         "status": "MACHINE_PROPOSED"},
        {"inference_id": "G2-INF2",
         "premise_ids": ["G2-CONC"],
         "conclusion_ids": ["G2-IC1"],
         "scheme": "CONCEPTUAL_DISTINCTION",
         "rationale": "The conclusion preserves the distinction between reflexive self-awareness and conceptual operations.",
         "defeaters": [],
         "status": "MACHINE_PROPOSED"},
    ]
