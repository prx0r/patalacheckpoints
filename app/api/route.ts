...
export async function GET(_req: NextRequest) {
  return NextResponse.json({
    ...
    endpoints: {
      ...
      resolve: ["GET /api/resolve", "POST /api/resolve/work"],
      verify: ["GET /api/verify/quote", "GET /api/verify/claim-structure", "GET /api/verify/counterevidence", "GET /api/verify/trace-dependency"],
      themes: ["GET /api/themes"],
      spines: ["GET /api/spines"],
      hub: ["GET /api/hub"],
      journey: ["GET /api/journey"],
      recommend: ["GET /api/recommend"],
      analyst: ["GET /api/analyst"],
      resources: ["GET /api/resources"],
      education: ["GET /api/education", "GET /api/education?id=learn-VERTICAL-1"],
      assertions: ["GET /api/assertions"],
      concordance: ["GET /api/concordance"],
      history: ["GET /api/history/timeline"],
      factory: ["GET /api/factory/status", "GET /api/factory/quality"],
      corpus: ["GET /api/corpus/state"],
      crosswalks: ["GET /api/crosswalks"],
      stats: ["GET /api/stats"],
