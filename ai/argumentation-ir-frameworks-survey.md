# Deep Research 10 — Argumentation & IR: existing-frameworks survey

> **Origin:** `deep-research-report(10).md` (imported from R2). Byte-identical to
> `machinelearning/_ACTIVE/philosophyengine4.md` and `machinelearning/_ACTIVE/DEEP-RESEARCH-ARGUMENTATION-TOOLS.md`.
> Canonical home: this file. Survey of mature argumentation/IR tools (py-aspic, xAIF/oAMF, ALIAS, ArgLLM, AKG, EAF)
> and how they map onto Pāṭala's 12-object IR — delegate computation, own the IR + provenance. See `ai/TAKEAWAYS.md`.
