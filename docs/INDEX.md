...
| **Vision index (full arc, Vision 01–11)** | `docs/vision/INDEX.md` | repo `docs/vision/` |
...
| **Vision 11 — Śiva Before Abhinava (genealogy corpus)** | `docs/vision/vision-11-siva-before-abhinava.md` | repo `docs/vision/` |
